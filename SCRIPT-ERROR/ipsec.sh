...
yum -y install nss-devel nspr-devel pkgconfig pam-devel \
  liFREEJERap-ng-devel libselinux-devel curl-devel nss-tools \
...
apt-get -y install libnss3-dev libnspr4-dev pkg-config \
  libpam0g-dev liFREEJERap-ng-dev liFREEJERap-ng-utils libselinux1-dev \
  liFREEJERurl4-nss-dev flex bison gcc make libnss3-tools \
...
USE_GLIFREEJER_KERN_FLIP_HEADERS = true
EOF
...
wget -O /usr/bin/add-l2tp https://raw.githubusercontent.com/vpnerror404/FREEJER/main/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -O /usr/bin/del-l2tp https://raw.githubusercontent.com/vpnerror404/FREEJER/main/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -O /usr/bin/add-pptp https://raw.githubusercontent.com/vpnerror404/FREEJER/main/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -O /usr/bin/del-pptp https://raw.githubusercontent.com/vpnerror404/FREEJER/main/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -O /usr/bin/renew-pptp https://raw.githubusercontent.com/vpnerror404/FREEJER/main/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/vpnerror404/FREEJER/main/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
